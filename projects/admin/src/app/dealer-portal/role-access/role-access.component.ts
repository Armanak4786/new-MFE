...
@Component({
    selector: 'app-dealer-role-access',
    templateUrl: './role-access.component.html',
    styleUrls: ['./role-access.component.scss']
})
export class DealerRoleAccessComponent implements OnInit {
    ...
    onRoleChange(): void {
        ...
        // Load permissions for selected role from API
    }

    exportPermissions(): void {
        console.log('Exporting permissions for Dealer:', {
    ...
    savePermissions(): void {
        console.log('Saving Dealer permissions:', {
            role: this.selectedRoleId,
            permissions: this.permissionCategories
        });
    }
