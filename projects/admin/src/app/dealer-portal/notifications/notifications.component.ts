...
export class DealerNotificationsComponent implements OnInit {
    ...
    uploadBanner(): void {
        ...
        console.log('Uploading banner for Dealer:', {
            offerId: this.selectedOfferId,
            isPrimary: this.isPrimary,
            message: this.message,
            fileName: this.bannerFileName
        });
        // API call to upload banner would go here
    }
    ...
    applyBanner(): void {
        ...
        console.log('Applying banner for Dealer:', {
            offerId: this.selectedOfferId,
            isPrimary: this.isPrimary,
            message: this.message,
            bannerImage: this.bannerImage
        });
        // API call to apply banner would go here
    }
}
