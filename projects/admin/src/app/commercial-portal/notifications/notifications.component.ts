...
@Component({
    selector: 'app-commercial-notifications',
    templateUrl: './notifications.component.html',
    styleUrls: ['./notifications.component.scss']
})
export class CommercialNotificationsComponent implements OnInit {
    ...
    uploadBanner(): void {
        ...
        console.log('Uploading banner for Commercial:', {
    ...
    applyBanner(): void {
        ...
        console.log('Applying banner for Commercial:', {
            offerId: this.selectedOfferId,
            isPrimary: this.isPrimary,
            message: this.message,
