...
@Component({
  selector: 'app-sole-contact-details',
  templateUrl: './contact-details.component.html',
  styleUrl: './contact-details.component.scss'
})
export class SoleContactDetailsComponent extends BaseSoleTradeClass{
  ...
  if (dobField) {
    dobField.maxDate = eighteenYearsAgo;
     ...
     BusinessformConfig: GenericFormConfig = {
      ...
      fields: [
        {
          ...
          cols: 6,
          className: "-ml-5 pl-0 w-4 dropdown-margin-fix",
          options: [],
      ...
      },
      {
        ...
        className: '-mx-8 pl-0 pt-5 business-area-code',
        inputType: 'vertical',
      },

       {
        ...
        inputClass:"sole-trade-business-email",
        inputType: "vertical",
      },
      ],
    ...
    IndividualformConfig: GenericFormConfig = {
        ...
        },
      {
        ...
        // alignmentType: "vertical",
        className: "ml-8 mt-4 pt-0 pb-0 pl-4",
        labelClass: "col-12 py-0",
      ...
      },
      {
...

       {
        ...
        cols: 4,
        className: "ml-6 mt-2 pl-7 pr-0 pt-4 w-4",
        labelClass:"pb-2",
        inputType: "vertical",
      },
      ],
