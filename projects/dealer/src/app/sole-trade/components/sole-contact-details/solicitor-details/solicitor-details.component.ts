...
@Component({
  selector: "app-solicitor-details",
  templateUrl: "./solicitor-details.component.html",
})
export class SoleSolicitorDetailsComponent extends BaseSoleTradeClass {
  override data: any;
  override mode;
  ...
  modelName: string = "SoleSolicitorDetailsComponent";
