...
import { SoleDetailsConfirmationComponent } from "./details-confirmation.component";
...
fdescribe("SoleDetailsConfirmationComponent", () => {
  let component: SoleDetailsConfirmationComponent;
  let fixture: ComponentFixture<SoleDetailsConfirmationComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [SoleDetailsConfirmationComponent],
    ...
    fixture = TestBed.createComponent(SoleDetailsConfirmationComponent);
