...
export class SoleBusinessContactDetailsComponent extends BaseSoleTradeClass  {
  constructor(
  ...
  override formConfig: GenericFormConfig = {
    headerTitle: "Business Contact Details",
    autoResponsive: true,
    api: "businessDetails",
  ...
  modelName: string = "SoleBusinessContactDetailsComponent";
