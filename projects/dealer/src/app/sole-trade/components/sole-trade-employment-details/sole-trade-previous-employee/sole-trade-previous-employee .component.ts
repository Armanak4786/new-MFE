...
@Component({
  selector: "app-sole-trade-previous-employee ",
  templateUrl: "./sole-trade-previous-employee .component.html",
  styleUrl: "./sole-trade-previous-employee .component.scss",
})
export class SoleTradePreviousEmploymentComponent extends BaseSoleTradeClass {
  ...
  override async onFormEvent(event: any): Promise<void> {
    ...
    // console.log("baseform", this.baseFormData);
  ...
  modelName: string = "SoleTradePreviousEmploymentComponent";
  ...
  override async onStepChange(quotesDetails: any): Promise<void> {
    ...
    if (quotesDetails.type !== "tabNav") {
     ...
     if(!this.baseSvc.isPreviousEmployeeVisible){
      ...
      this.baseSvc.updateComponentStatus("Employment Details", "SoleTradePreviousEmploymentComponent", this.mainForm.form.valid)
    }
  ...
  patchValue() {
    ...
    if (
      ...
      this.mainForm
        .get("previousEmployer")
        .patchValue(this.baseFormData?.employementDetails[1]?.employerName);
      this.mainForm
        .get("previousOccupation")
        .patchValue(this.baseFormData?.employementDetails[1]?.occupationType);
      this.mainForm
        .get("previousEmploymentType")
        .patchValue(this.baseFormData?.employementDetails[1]?.employmentStatus);
