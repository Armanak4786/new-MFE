...
@Component({
  selector: "app-trustee-details",
  templateUrl: "./trustee-details.component.html",
  styleUrl: "./trustee-details.component.scss",
})
export class TrusteeDetailsComponent extends BaseTrustClass {
   formData: any;
   formConfig1:any;
    countryCodeOptions: any = [];
    TrusteereferenceDetailsTemp: any = [];
    referenceDetails: any[] = [
      ...
      //   contactType : "Subhashish",
      //   legalName : "Prasad Kashid",
      //   // dateOfBirth: "16/07/2003",
      //   mobile: "+91",
      //   phoneAreaCode: "91",
      //   phone : "594939",
    ...
    constructor(
      ...
      super(route, svc, baseSvc);
       this.standardQuoteSvc.formDataCacheableRoute(["LookUpServices/lookups?LookupSetName=ContactType",]);
    }
  ...
  // const dobField = this.formConfig1.fields.find(f => f.name === 'TrusteeindividualDateOfBirth');
  // if (dobField) {
  //   dobField.maxDate = eighteenYearsAgo;
  // }
  //     console.log("ReferenceDetailsComponent ngOnInit called", this.baseFormData);
      // this.svc.countryCodeOptions.subscribe((data) => {
      //   this.countryCodeOptions = data;
      //   this.mainForm.updateList('referencePhoneExt', this.countryCodeOptions);
      // });
   
        if(this.baseFormData.TrusteereferenceDetailsTemp){
          this.referenceDetails = this.baseFormData?.TrusteereferenceDetailsTemp
        }
    ...
    BusinessformConfig: GenericFormConfig = {
        ...
        fields: [
          {
            type: "select",
            label: "Contact Type",
            name: "TrusteebusinessContactType",
            cols: 6,
            className: "-ml-5 pl-0 w-4 mt-2",
            labelClass: "-mt-2",
            alignmentType: "vertical",
            options: [
               { label: "Trustee", value: "Trustee" },
              //  { label: "Proessional Trustee", value: "Influencer" },
              ],
          ...
          },
          {
            ...
            name: "TrusteebusinessLegalName",
            cols: 6,
            inputType: "vertical",
              className: "mx-2 col-6 mt-3  w-5",
          ...
          // },
          {
            type: "toggle",
            label: "Signatory",
            name: "TrusteebusinessSignatory",
            cols: 2,
            className: "mt-5 w-4 pl-0 -mx-4",
            // inputClass: "",
            // labelClass:"",
            alignmentType: "vertical",
            offLabel: "Yes",
        ...
        },
        {
          ...
          cols: 1,
          name: "year",
          className: "mt-5 pt-3 mx-4 px-0 col-fixed w-4rem",
        },
        {
          type: 'phone',
          name: 'TrusteebusinessPhoneNumber',
          labelClass: "hidden",
          //placeholder: 'Number',
          cols: 2,
          // maxLength: 10,
          // validators: [Validators.pattern('^[0-9]{1,10}$')],
        className: '-mx-8 mt-5 pl-0 pt-5',
          inputType: 'vertical',
        },
  
         {
          type: "email",
          label: "Email",
          name: "TrusteebusinessEmail",
          cols: 4,
          className: "ml-3 mt-3 pl-8 pr-0 pt-5",
          inputClass: "-mt-2",
          inputType: "vertical",
        },
        ],
    ...
    IndividualformConfig: GenericFormConfig = {
        ...
        fields: [
          {
            type: "select",
            label: "Contact Type",
            name: "TrusteeindividualContactType",
            alignmentType: "vertical",
            cols: 3,
            className: "-ml-5 pl-0  dropdown-margin-fix",
            options: [
               { label: "Trustee", value: "Trustee" },
              //  { label: "Proessional Trustee", value: "Influencer" },
              ],
          ...
          },
          {
            ...
            inputType : "vertical",
            name: "TrusteeindividualFirstName",
            cols: 3,
            inputClass: "mr-3",
            labelClass: "mt-2 mb-0"
            //validators: [validators.pattern("^[0-9]{1,4}$")],
            //min: 1990,
            //max: 2024,
          },
          {
            ...
            name: "TrusteeindividualLastName",
            inputType : "vertical",
            cols: 3,
            inputClass: "",
            labelClass: "mt-2 mb-0"
          ...
          },
          {
            type: "date",
            label: "Date of Birth",
            name: "TrusteeindividualDateOfBirth",
            inputType : "vertical",
            cols: 3,
            className: "",
            defaultDate: this.allowedDate,
            maxDate: this.allowedDate,
            // defaultDate: "2025-07-16"
            // maxLength: 10,
          },
          {
            type: "toggle",
            label: "Signatory",
            name: "TrusteeindividualSignatory",
            cols: 2,
            className: "-mx-5 mt-4",
            inputClass: "mt-2",
            labelClass:"mb-2",
        ...
        },
        {
          type: 'phone',
          labelClass: "hidden",
          name: 'TrusteeindividualPhoneNumber',
          //placeholder: 'Number',
          cols: 2,
          // maxLength: 10,
          // validators: [Validators.pattern('^[0-9]{1,10}$')],
    ...
    MaintainTempArray(){
      this.baseSvc.setBaseDealerFormData({
        TrusteereferenceDetailsTemp : this.TrusteereferenceDetailsTemp
      })
      console.log("TempArray", this.baseFormData.TrusteereferenceDetailsTemp , this.baseFormData)
    }
    ...
    showReferenceDetailPopup() {
      this.svc.dialogSvc
        ...
        .onClose.subscribe((res: any) => {
          if(res?.data){
            console.log("calling times")
            this.referenceDetails.push(res?.data)
            this.TrusteereferenceDetailsTemp = this.referenceDetails
            this.MaintainTempArray()
            console.log("Testtttttt", this.baseFormData)
          }
          console.log("Onclose Ref res : ", res);
          // if (res?.submitType == "submit") {
          //   this.mainForm.form.patchValue({
          //     referenceSearch: res?.searchText,
          //   });
          // }
  ...
  editReference(reference: any, index: number) {
      console.log("Edit Ref ", reference , index)
      ...
      .onClose.subscribe((res: any) => {
        console.log("Onclose response: ",res, this.baseFormData)
        ...
        if (res?.data) {
          ...
          this.TrusteereferenceDetailsTemp = this.referenceDetails
          this.MaintainTempArray();
          console.log(this.referenceDetails, "change after edit")
        }
        this.baseSvc.setBaseDealerFormData({
          classification : null,
          individualContactType : null,
  ...
  if (referenceToDelete?.customerNo && referenceToDelete?.customerContactId) {
    this.svc.data
      ...
      .subscribe((res) => {
        console.log('Contact deleted on server');
      });
  }
