...
import { TrustCustomerReferenceComponent } from "./trust-customer-reference.component";
...
fdescribe("TrustCustomerReferenceComponent", () => {
  let component: TrustCustomerReferenceComponent;
  let fixture: ComponentFixture<TrustCustomerReferenceComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [TrustCustomerReferenceComponent],
      imports: [BrowserDynamicTestingModule, LibSharedModule, AppPrimengModule],
      providers: [
        CommonService,
        TrustService,
        JwtHelperService,
    ...
    fixture = TestBed.createComponent(TrustCustomerReferenceComponent);
  ...
  it("should initialize formConfig with correct values", () => {
    ...
    expect(component.formConfig.fields[0].name).toBe("trustReferenceNumber");
  });
  it("should have correct formConfig setup", () => {
    ...
    expect(field.name).toBe("trustReferenceNumber");
