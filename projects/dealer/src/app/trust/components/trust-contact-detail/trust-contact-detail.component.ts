...
@Component({
  selector: "app-trust-contact-detail",
  templateUrl: "./trust-contact-detail.component.html",
  styleUrl: "./trust-contact-detail.component.scss",
})
export class TrustContactDetailComponent extends BaseTrustClass {
  ...
  //     console.log("ReferenceDetailsComponent ngOnInit called", this.baseFormData);
    ...
    IndividualformConfig: GenericFormConfig = {
        ...
        },
      {
        ...
        labelClass: "col-12 py-0 trust-individual-mobile",
    ...
    MaintainTempArray(){
      ...
      console.log("TempArray", this.baseFormData.referenceDetailsTemp , this.baseFormData)
    }
