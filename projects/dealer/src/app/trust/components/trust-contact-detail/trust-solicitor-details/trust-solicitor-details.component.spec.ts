...
import { TrustSolicitorDetailsComponent } from "./trust-solicitor-details.component";
...
fdescribe("TrustSolicitorDetailsComponent", () => {
  let component: TrustSolicitorDetailsComponent;
  let fixture: ComponentFixture<TrustSolicitorDetailsComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [TrustSolicitorDetailsComponent],
    ...
    fixture = TestBed.createComponent(TrustSolicitorDetailsComponent);
  ...
  it("should define the formConfig with correct structure", () => {
    ...
    expect(component.formConfig.headerTitle).toBe("Solicitor Details");
  ...
  it("should have correct configuration for the First Name field", () => {
    const firstNameField = component.formConfig.fields.find(
      (f) => f.name === "trustSolicitorfirstName"
    );
  ...
  it("should have correct configuration for the Last Name field", () => {
    const lastNameField = component.formConfig.fields.find(
      (f) => f.name === "trustSolicitorlastName"
    );
  ...
  it("should have correct configuration for the Mobile Number select field", () => {
    const phoneCodeField = component.formConfig.fields.find(
      (f) => f.name === "trustSolicitorPhoneCode"
    );
  ...
  it("should have correct configuration for the Area Code field", () => {
    const areaCodeField = component.formConfig.fields.find(
      (f) => f.name === "trustSolicitorAreaCode"
    );
  ...
  it("should validate email address", () => {
    const emailControl = component.mainForm.get("trustSolicitoremail");
