...
import { TrustContactDetailsCardComponent } from "./trust-contact-details-card.component";
...
fdescribe("TrustContactDetailsCardComponent", () => {
  let component: TrustContactDetailsCardComponent;
  let fixture: ComponentFixture<TrustContactDetailsCardComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [TrustContactDetailsCardComponent],
    ...
    fixture = TestBed.createComponent(TrustContactDetailsCardComponent);
  ...
  it("should define the formConfig with correct structure", () => {
    ...
    expect(component.formConfig.headerTitle).toBe("Trust Contact Details");
  ...
  it("should have correct configuration for the First Name field", () => {
    const firstNameField = component.formConfig.fields.find(
      (f) => f.name === "trustContactfirstName"
    );
  ...
  it("should have correct configuration for the Mobile Number select field", () => {
    const phoneCodeField = component.formConfig.fields.find(
      (f) => f.name === "trustContactPhoneCode"
    );
  ...
  it("should validate email address", () => {
    const emailControl = component.mainForm.get("trustContactemail");
