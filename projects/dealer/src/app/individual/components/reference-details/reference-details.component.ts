...
export class ReferenceDetailsComponent extends BaseIndividualClass {
  formData: any;
  ...
  constructor(
    ...
    public cdr: ChangeDetectorRef // public config : DynamicDialogConfig
  ) {
    ...
    fields: [
      {
        ...
        cols: 6,
        className: "-ml-5 pl-0 w-4 business-contact-type-dropdown",
        options: [],
      ...
      },
      {
        ...
        // alignmentType: "vertical",
        className: "ml-3 pt-4 px-3 individual-mobile-country-code",
...

      {
        ...
        className: " ml-3 mt-3 pl-8 pr-0 py-2 individual-mobile-country-code",
        inputType:"vertical",
      },
    ],
  };
    ...
    fields: [
      {
        ...
        cols: 3,
        options: [],
        className: "-ml-5 pt-0 dropdown-margin-fix",
      ...
      },
      {
        ...
        // alignmentType: "vertical",
        className: "ml-8 mt-5 pt-0 pb-0 pl-4 individual-mobile-country-code",
...

      {
        ...
        cols: 3,
        className: "pb-0 mt-5 ml-4",
        inputClass: "mt-3 w-12",
        // labelClass: "pl-4",
        inputType: "vertical",
      },
    ],
    ...
    this.svc.dialogSvc
      .show(AddContactsComponent, "", {
        ...
        data: {
          ...
          contactOwnerRole:
            this.baseFormData?.customerContractRole?.roleName || "",
        },
        width: "60vw",
      })
  ...
  removeReference(reference: any, index: number) {
    // Restore from baseFormData if available
    if (this.baseFormData?.referenceDetailsTemp) {
      this.referenceDetails = this.baseFormData?.referenceDetailsTemp;
    }

    // Get the reference to be deleted from the current index
  ...
  // this.baseSvc.updateComponentStatus("Reference Details", "individualCustomerType", this.mainForm.form.valid)
