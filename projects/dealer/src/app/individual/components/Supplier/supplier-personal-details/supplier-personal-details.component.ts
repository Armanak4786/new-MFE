...
export class SupplierPersonalDetailsComponent extends BaseIndividualClass {
  ...
  constructor(
    ...
    config, 'SupplierPersonalDetailsComponent', 'AddSupplierIndividualComponent');
    this.formConfig = { ...this.formConfig, fields: filteredValidations };
    console.log('Supplier personal detail fields:', filteredValidations);
  ...
  override async ngOnInit(): Promise<void> {
    ...
    this.mainForm?.updateList("individualSupplierMobile", countryCodeOptions);
