...
@Component({
  selector: 'app-turnover-information',
  templateUrl: './turnover-information.component.html',
  styleUrl: './turnover-information.component.scss',
})
export class TurnoverInformationComponent extends BaseBusinessClass implements OnDestroy {
    ...
    fields: [
      {
        ...
        typeOfLabel: 'inline',
        label: 'Amount',
        name: 'businessTurnoverAmountLabel',
        cols: 4,
      ...
      },
      {
        ...
        typeOfLabel: 'inline',
        label: 'Year Ending',
        name: 'businessTurnoverYearEndingLabel',
        cols: 3,
  ...
  //   const latestRaw = event?.turnoverLatestYearEndingDt;
  //   if (!latestRaw || this.isPlaceholderMinDate(latestRaw)) {
  //     return;
  //   }
  ...
  override ngOnDestroy() {
   ...
   override onStepChange(stepperDetails: any): void {
    ...
    this.baseSvc.updateComponentStatus("Financial Accounts", "TurnoverInformationComponent", this.mainForm.form.valid)
  }
 ...
 override async onBlurEvent(event): Promise<void> {
  ...
  modelName: string = "BusinessTurnoverInfoComponent";
  ...
  //   let latestyear = event?.turnoverLatestYearEndingDt;
  //   console.log('Latest Year Turnover:', latestyear);

  //   if (latestyear) {
  //     // Convert the date string to a Date object
  //     const latestDate = new Date(latestyear);
      
  //     // Subtract one year
  //     const prevYearDate = new Date(latestDate);
  //     prevYearDate.setFullYear(latestDate.getFullYear() - 1);
      
  //     // Format the date back to the same format (assuming YYYY-MM-DD)
